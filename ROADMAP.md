...
- `[v]` **Статистика на панели:** текущая комбинация, статус, businessBlock/теги, страница `N/total`, прогресс комбинаций, **собрано** (выгружено) + **`newsCount`** из `body.newsCount`, ошибки.
...
- `[v]` **newsCount:** из `body.newsCount` первого ответа комбинации — ячейка статистики рядом с «собрано».
