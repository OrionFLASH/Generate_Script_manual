...
*Базовая функциональность скриптов в § 1–8 отмечена `[v]` по состоянию репозитория; пункты `[ ]` в § 0 и в опциональных подразделах — про сопровождение и дальнейшие улучшения, а не о «незавершённом» коде.*
