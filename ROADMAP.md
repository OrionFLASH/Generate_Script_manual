...
- `[v]` Режим **Play**: вкладка, загрузка `_ui.log`, прокликивание; накопление тест-лога без автосохранения; сохранение `_test_` по кнопке; стабильные селекторы (name/aria/xpath), ожидание модалок; Docs подробно.
