...
Кнопка **⏸ Пауза** (в верхней строке операций) не отменяет прогон, а замораживает отправку следующих запросов до нажатия **▶ Продолжить**. Одновременно может идти только одна операция.
