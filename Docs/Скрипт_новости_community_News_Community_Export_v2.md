...
- пагинация с ретраями; паузы / попытки / макс. страниц / аварийный стоп — из **общего блока панели**;
...
| Макс. страниц | Лимит страниц на комбинацию выгрузки (`0` = все); при загрузке для edit перекрывает локальный лимит, если > 0 |
