...
Вкладки — компактная строка **сверху**; рабочая область на всю ширину. Журнал и кнопки Trace вынесены ближе к общему блоку параметров (без пустого разрыва). Подсказки в окнах — мелкий шрифт (10px).
