...
На панели — статистика (status, block, **теги**, **собрано**, **newsCount**, **повторов**, **ошибок**) и **журнал/трейс** сразу под параметрами. JSON/CSV неактивны без status/block. Подробности: [Docs/Скрипт_новости_community_News_Community_Export.md](Скрипт_новости_community_News_Community_Export.md) (**v3.1**).
