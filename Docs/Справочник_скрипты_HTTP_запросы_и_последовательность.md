...
1. Общий блок панели: паузы операций/страниц, макс. страниц, пауза повтора, число попыток, аварийный стоп после N ошибок подряд, кнопка **Стоп**.
2. Вкладка «Выгрузка»: выбор status/block/tag, POST-пагинация с общими ретраями/паузами и сохранение JSON.
