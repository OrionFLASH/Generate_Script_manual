...
5. **⏹ Стоп** → **⬇ JSON + .log** (оба файла с одним timestamp).
...
| **⬇ JSON + .log** | Сохраняет **оба** файла одной кнопкой с общим timestamp: JSON (ответы без маски) и `.log` (полный дамп с фильтром/маской) |
...
|--------|------|-----------|
| 1.3 | 2026-08-05 | Одна кнопка **⬇ JSON + .log** — оба файла с общим timestamp |
