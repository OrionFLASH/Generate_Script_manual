...
Живой блок «Статистика работы»: фаза, `newsStatus`, `businessBlock`, **теги** (отдельная ячейка; при запросе с тегами — коды выбранных), страница `pageNum/total`, прогресс комбинаций, число новостей, ошибки/пропуски.
...
- Статистика: фаза, status, block, **теги**, стр., прогресс, новостей, ошибок
...
=======
| **2.8** | Запуск только при ≥1 status и ≥1 businessBlock; теги опциональны (в payload вместе с block) |
| **2.9** | Журнал/трейс сразу под параметрами (выше); в статистике отдельная ячейка «теги» |
>>>>>>> origin/orionflash/news-log-layout-tags-stat-6892
